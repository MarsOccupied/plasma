import PlasmaContract from '@marsoccupied/plasma-client/lib/contract/PlasmaContract';
import IRootClient from '@marsoccupied/plasma-client/lib/rpc/IRootClient';
import SendOperation from '@marsoccupied/plasma-client/lib/operations/SendOperation';
import ExitOperation from '@marsoccupied/plasma-client/lib/operations/ExitOperation';
import {toBig} from '@marsoccupied/plasma-client/lib/util/numbers';
...
import Outpoint from '@marsoccupied/plasma-client/lib/domain/Outpoint';
import {selectUTXOs} from '@marsoccupied/plasma-client/lib/domain/selectUTXOs';
