# @marsoccupied/plasma-client

This is the JavaScript SDK for MarsOccupied's Plasma Core implementation. Plasma enables instant, low-fee, trustless payments on the Ethereum blockchain.
...
```bash
npm install --save @marsoccupied/plasma-client
# or
yarn add @marsoccupied/plasma-client
```
...
```javascript
import Plasma from '@marsoccupied/plasma-client';
